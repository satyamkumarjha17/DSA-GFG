...
<ul>
<li data-start="571" data-end="632"><span style="font-size: 14pt;">In one move, he can move to any of the four adjacent cells (up, down, left, or right), provided that the adjacent cell lies inside the maze and is not an obstacle. </span></li>
<li data-start="571" data-end="632"><span style="font-size: 14pt;">Geek can make at most <strong>u</strong> upward moves and at most <strong>d</strong> downward. </span></li>
